...
mov ss, ax
mov sp, 0x9000        ;
Safer stack (above bootloader, below kernel)
sti
...
Head 0
mov cl, 0x02        ;
Start from sector 2 (after boot sector)
int 0x13
jc disk_error
popa
ret
...
db 11001111b    ;
Flags:
granularity, 32-bit, limit (bits 16-19)
db 0x0          ;
Base (bits 24-31)
